...
import { image1, image2, image3, news1 } from "../image";
...
const Dashboard: React.FC = () => {
    ...
    const cardStats = [

        {
            ...
            total: '3.456K',
            rate: '0.43%',
            icon: <IoEyeOutline size={20} color={mode === 'light' ? '#3C50E0' : 'white'} />
        },
        {
            title: 'Total Articles',
            total: '80,2K',
            rate: '4.35%',
            icon: <GrArticle size={20} color={mode === 'light' ? '#3C50E0' : 'white'} />
        },
        {
            title: 'Total Event',
            total: '2.450',
            rate: '2.59%',
            icon: <BsCalendar3Event size={20} color={mode === 'light' ? '#3C50E0' : 'white'} />
        },
        {
            title: 'Total Users',
            total: '3.456',
